 ...
 * @author richard
 */
public class Cuadrado extends NodoAST{
    Expresion posx;
    Expresion posy;
    String color;
    Expresion ancho;
    Expresion alto;
    public Cuadrado(int linea, int columna, String Archivo, Expresion posx, Expresion posy, String color, Expresion ancho, Expresion alto) {
    ...
    public Object generateByteCode(Ambito ambito) {
        try {
            ...
            /*****************************************************************/
            if((tipox.equals("ENTERO")||tipox.equals("DECIMAL")) && (tipoy.equals("ENTERO")||tipoy.equals("DECIMAL")) && (aTipo.equals("ENTERO")||aTipo.equals("DECIMAL")) && (alTipo.equals("ENTERO")||alTipo.equals("DECIMAL")))
            {
                String cad = "\n/*********************************************************/\n";
                cad += "// METIENDO EN PILA PARAMETROS DE FUNCION CUADRADO\n";
                cad += "// COORDENADA X\n";
                cad += xcode+"\n";
                cad += "// COORDENADA Y\n";
                cad += ycode+"\n";
            ...
            InfoEstatica.Estatico.agregarError(new TError(
                    "No Aplica", 
                    "Error al traducir Funcion de Cuadrado: "+e.getMessage(), 
                    "Ejecucion", 
                    super.getLinea(), 
                    super.getColumna(), 
                    Boolean.FALSE, 
