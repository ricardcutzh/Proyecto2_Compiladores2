...
public class SetLocalRet extends NodoAST implements SentenciaDasm{
    ...
    public Object Ejecuta(EntornoDasm entorno, IP instrucctionPointer) {
        try 
        {
            ...
            entorno.getPosicionRet().setValor(valor);// COLOCO EN RET EL VALOR QUE ESTA EN LA CIMA
        } catch (Exception e) 
        {
            InfoEstatica.Estatico.agregarError(new TError("No Aplica", "Error al ejetucar 'set_local $ret': "+e.getMessage(), "Ejecucion", super.getLinea(), super.getColumna(), Boolean.FALSE, super.getArchivo()));
        }
