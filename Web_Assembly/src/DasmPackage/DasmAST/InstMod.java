 ...
 * @author richard
 */
public class InstMod extends NodoAST implements SentenciaDasm{
    
    public InstMod(int linea, int columna, String Archivo) {
    ...
    public Object Ejecuta(Object objeto) {
        try {
            ...
            InfoEstatica.Estatico.agregarError(new TError("MOD", "Error al ejecutar MOD: "+e.getMessage(), "Ejecucion", super.getLinea(), super.getColumna(), Boolean.FALSE, super.getArchivo()));
        }
        return null;
    }
