...
/**
 * Clase que maneja la multiplicacion en la Pilita
 * @author richard
 */
public class InstMult extends NodoAST implements SentenciaDasm{

    public InstMult(int linea, int columna, String Archivo) {
    ...
    public Object Ejecuta(Object objeto) {
        try {
            ...
            InfoEstatica.Estatico.agregarError(new TError("MULT", "Error al ejecutar MULT: "+e.getMessage(), "Ejecucion", super.getLinea(), super.getColumna(), Boolean.FALSE, super.getArchivo()));
        }
        return null;
    }
