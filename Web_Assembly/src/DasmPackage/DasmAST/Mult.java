...
public class Mult extends NodoAST implements SentenciaDasm{
    /**
     * Clase que maneja la multiplicacion de operandos en la pilita
     * @param linea
     * @param columna
     * @param Archivo 
     */
    ...
    public Object Ejecuta(EntornoDasm entorno, IP instrucctionPointer) {
        ...
        {
            InfoEstatica.Estatico.agregarError(new TError("No Aplica", "Error al ejecutar Mult: "+e.getMessage(), "Ejecucion", 
