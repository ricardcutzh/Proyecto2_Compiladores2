...
/**
 * Clase que representa las referencias a las funciones que deben existir para
 * su traduccion
 *
 * @author richard
 */
public class MetodoFuncion extends NodoAST {
    ...
    public void insertParams(Ambito ambito) {
        for (NodoParametro n : this.parametros) {
            /*TENGO QUE INSERTAR LOS PARAMETROS COMO ARREGLOS*/
            if (n.getSoyVector()) {
                ambito.addDppSimbol(n.getIdParametro(), new DppArr(n.getIdParametro(), Boolean.TRUE, n.getTipo(), ambito.getSize(), n.getDimensiones(), 1, ambito.getIdAmbito()));
            } else {
